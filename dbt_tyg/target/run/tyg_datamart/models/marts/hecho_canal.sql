            ...
            using "hecho_canal__dbt_tmp060259903869"
            where (
                
                    "hecho_canal__dbt_tmp060259903869".dtiem_id = "tyg_datamart"."marts_marts"."hecho_canal".dtiem_id
                    and 
                
                    "hecho_canal__dbt_tmp060259903869".dofic_id = "tyg_datamart"."marts_marts"."hecho_canal".dofic_id
    ...
    (
        ...
        from "hecho_canal__dbt_tmp060259903869"
    )
