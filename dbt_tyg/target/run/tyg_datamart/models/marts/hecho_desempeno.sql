            ...
            using "hecho_desempeno__dbt_tmp060259886852"
            where (
                
                    "hecho_desempeno__dbt_tmp060259886852".dtiem_id = "tyg_datamart"."marts_marts"."hecho_desempeno".dtiem_id
                    and 
                
                    "hecho_desempeno__dbt_tmp060259886852".dofic_id = "tyg_datamart"."marts_marts"."hecho_desempeno".dofic_id
                    and 
                
                    "hecho_desempeno__dbt_tmp060259886852".dases_id = "tyg_datamart"."marts_marts"."hecho_desempeno".dases_id
    ...
    (
        ...
        from "hecho_desempeno__dbt_tmp060259886852"
    )
