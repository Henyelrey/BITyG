...
WITH base AS (
    SELECT * FROM "tyg_datamart"."marts_staging"."stg_ventas"
...
FROM base b
LEFT JOIN "tyg_datamart"."raw"."oficinas"    o     ON b.oficina_id    = o.oficina_id
LEFT JOIN "tyg_datamart"."raw"."recepciones" r_dim ON b.recepcion_id  = r_dim.recepcion_id
